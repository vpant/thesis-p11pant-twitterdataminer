...
public class TwitterException extends Exception implements HttpResponseCode {

	private static final long serialVersionUID = 8598023567970767697L;
	...
	public String getMessage()
	{
		if (responseCode != -1)
		{
			return message + " " + getCause(responseCode);
	...
	private static String getCause(int statusCode) {
	        ...
	        switch (statusCode) {
	            ...
	            case UNAUTHORIZED:
	                ...
	                break;
	            case FORBIDDEN:
	                cause = "The request is understood, but it has been refused. Authorization was not valid.";
	                break;
	            case NOT_FOUND:
